...
Mac 1.9.0（12）已在收盘总结加入[昨日实时策略的今日收益](docs/REALTIME_DAILY_VERIFICATION_20260910.md)：分列昨收至今收、提醒价至今收的复权观察表现，保留来源轮次、逐股价格及缺数状态。[达塔批量初筛＋D6逐股复核](docs/D101_BATCH.md)、日线更新及服务器离线接管继续按原配置运行；[底部放量](docs/BOTTOM_VOLUME.md) 仍为 14:30 检查至少 2.5 倍且当日上涨。
