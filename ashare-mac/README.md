...
Mac 1.7.0（8）默认读取与手机相同的四策略发布版本，切换使用缓存；自选通过逐条操作跨设备同步。首页精简为候选、最近观察结算与下次检查，K 线增加观察日期及参考线。实时提醒支持固定轮次，并新增 [14:30 底部放量三倍](docs/BOTTOM_VOLUME.md)。本次上线和验证边界见 [验收记录](docs/PRODUCT_VERIFICATION_20260908.md)。
