...
@main struct NotificationTests {
    static func main() throws {
        ...
        func bottomArchive(version:Int?,volume:Double,change:Double) throws -> RealtimeSnapshot {
            ...
            let snapshot:[String:Any] = ["date":"20260908","previous_date":"20260907","generated_at":1788849000.0,
