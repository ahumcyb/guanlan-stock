...
swiftc -parse-as-library -target arm64-apple-macosx14.0 ../ashare-mac/macos/Models.swift \
  ...
  ../ashare-mac/macos/RealtimeModels.swift Sources/Core/Connection.swift Sources/Core/Snapshots.swift Sources/Core/JevDaily.swift Tests/JevTests.swift -o .cache/jev-native-tests
