...
iOS 1.6.0（8）已于 2026-09-08 安装并启动：四策略原子缓存、自选同步、全池搜索、通知固定轮次、底部放量三倍与更精简的日报。真机回读版本正确，四报告 SHA-256 与 Mac 同代缓存一致，9 月 8 日新版总结已同步。新底部策略的名称、代码、倍数会写入通知正文，旧版本也可阅读。详见 [本轮验收](../ashare-mac/docs/PRODUCT_VERIFICATION_20260908.md)。
