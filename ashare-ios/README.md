...
iOS 1.6.0（8）代码已完成：四策略原子缓存、自选同步、全池搜索、通知固定轮次、底部放量三倍与更精简的日报。模拟器构建和原生逻辑测试通过，按用户要求暂未更新手机。新底部策略的名称、代码、倍数会写入通知正文，旧版本也可阅读。详见 [本轮验收](../ashare-mac/docs/PRODUCT_VERIFICATION_20260908.md)。
