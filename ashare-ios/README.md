...
iOS 1.8.0（12）新增[昨日实时策略的今日收益](../ashare-mac/docs/REALTIME_DAILY_VERIFICATION_20260910.md)，支持两个收益口径、来源轮次、逐股价格与未结算说明。已完成签名构建和原生测试；用户手机不在旁边，本次尚未安装。Mac 主节点继续[达塔批量初筛＋D6逐股复核](../ashare-mac/docs/D101_BATCH.md)，服务器离线接管保留原行情备用；后台总结不依赖手机运行。
