...
iOS 1.6.1（9）已于 2026-09-08 安装并启动，底部放量改为 **累计量至少 2.5 倍且当日上涨**，策略说明与结果校验同步更新。真机回读版本正确；四策略原子缓存、自选同步、全池搜索、固定通知轮次与新版日报继续可用。新规则和原规则的历史记录分别保留当时条件。详见 [本次规则更新验收](../ashare-mac/docs/BOTTOM_VOLUME_25_VERIFICATION.md) 与 [此前产品验收](../ashare-mac/docs/PRODUCT_VERIFICATION_20260908.md)。
