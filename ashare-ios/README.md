...
iOS 1.7.0（10）已安装，数据页显示实际主备行情配置。Mac 主节点使用达塔 D6，服务器离线接管保留原行情备用；手机读取统一发布结果。底部放量仍为 **至少 2.5 倍且当日上涨**。本次启动时手机锁定，解锁后可打开新版。详见 [达塔接入验收](../ashare-mac/docs/DATTA_VERIFICATION_20260909.md)。
